...
# connect engine to hawaii.sqlite
...
def precip():
    ...
    # Calculate the date one year from teh last date in data set
...
def temperatures():
    ...
    # Perform a query to retrieve the temeperatures from the most active station from the past year
